...
class Transportaional extends StatefulWidget {
  ...
  const Transportaional({Key? key, required this.section}) : super(key: key);
...
class _TransportaionalState extends State<Transportaional> {
  ...
  Future<void> fetchDocuments() async {
    try {
      ...
      final sectionKey = "transportaional"; // Manually set section name for now
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: (String value) async {
                  ...
                  switch (value) {
                    ...
                    case 'Download Image':
                      downloadImage(context,imageUrl, "transportaional_${index + 1}.jpg");
                      break;
                  }
                },
