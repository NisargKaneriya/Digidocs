...
class Sscmarksheet extends StatefulWidget {
  ...
  const Sscmarksheet({Key? key, required this.section}) : super(key: key);
...
class _SscmarksheetState extends State<Sscmarksheet> {
  ...
  Future<void> fetchDocuments() async {
    try {
      ...
      final sectionKey = "sscmarksheet"; // Manually set section name for now
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: (String value) async {
                  ...
                  switch (value) {
                    ...
                    case 'Download Image':
                      downloadImage(context,imageUrl, "sscmarksheet_${index + 1}.jpg");
                      break;
                  }
                },
