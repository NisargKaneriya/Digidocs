...
class Healthandwellness extends StatefulWidget {
  ...
  const Healthandwellness({Key? key, required this.section}) : super(key: key);
...
class _HealthandwellnessState extends State<Healthandwellness> {
  ...
  Future<void> fetchDocuments() async {
    try {
      ...
      final sectionKey = "healthandwellness"; // Manually set section name for now
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: (String value) async {
                  ...
                  switch (value) {
                    ...
                    case 'Download Image':
                      downloadImage(context,imageUrl, "healthandwellness_${index + 1}.jpg");
                      break;
                  }
                },
