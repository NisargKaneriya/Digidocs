...
class Rationcard extends StatefulWidget {
  ...
  const Rationcard({Key? key, required this.section}) : super(key: key);
...
class _RationcardState extends State<Rationcard> {
  ...
  Future<void> fetchDocuments() async {
    try {
      ...
      final sectionKey = "rationcard"; // Manually set section name for now
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: (String value) async {
                  ...
                  switch (value) {
                    ...
                    case 'Download Image':
                      downloadImage(context,imageUrl, "rationcard_${index + 1}.jpg");
                      break;
                  }
                },
