...
class Drivinglincense extends StatefulWidget {
  ...
  const Drivinglincense({Key? key, required this.section}) : super(key: key);
...
class _DrivinglincenseState extends State<Drivinglincense> {
  ...
  Future<void> fetchDocuments() async {
    try {
      ...
      final sectionKey = "drivinglincense"; // Manually set section name for now
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: (String value) async {
                  ...
                  switch (value) {
                    ...
                    case 'Download Image':
                      downloadImage(context,imageUrl, "drivinglincense_${index + 1}.jpg");
                      break;
                  }
                },
