...
class Hscmarksheet extends StatefulWidget {
  ...
  const Hscmarksheet({Key? key, required this.section}) : super(key: key);
...
class _HscmarksheetState extends State<Hscmarksheet> {
  ...
  Future<void> fetchDocuments() async {
    try {
      ...
      final sectionKey = "hscmarksheet"; // Manually set section name for now
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: (String value) async {
                  ...
                  switch (value) {
                    ...
                    case 'Download Image':
                      downloadImage(context,imageUrl, "hscmarksheet_${index + 1}.jpg");
                      break;
                  }
                },
