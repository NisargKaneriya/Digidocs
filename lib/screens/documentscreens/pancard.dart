...
class Pancard extends StatefulWidget {
  ...
  const Pancard({Key? key, required this.section}) : super(key: key);
...
class _PancardState extends State<Pancard> {
  ...
  Future<void> fetchDocuments() async {
    try {
      ...
      final sectionKey = "pancard"; // Manually set section name for now
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: (String value) async {
                  ...
                  switch (value) {
                    ...
                    case 'Download Image':
                      downloadImage(context,imageUrl, "pancard_${index + 1}.jpg");
                      break;
                  }
                },
