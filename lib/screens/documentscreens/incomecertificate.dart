...
class Incomecertificate extends StatefulWidget {
  ...
  const Incomecertificate({Key? key, required this.section}) : super(key: key);
...
class _IncomecertificateState extends State<Incomecertificate> {
  ...
  Future<void> fetchDocuments() async {
    try {
      ...
      final sectionKey = "incomecertificate"; // Manually set section name for now
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: (String value) async {
                  ...
                  switch (value) {
                    ...
                    case 'Download Image':
                      downloadImage(context,imageUrl, "incomecertificate_${index + 1}.jpg");
                      break;
                  }
                },
