...
class Banking extends StatefulWidget {
  ...
  const Banking({Key? key, required this.section}) : super(key: key);
...
class _BankingState extends State<Banking> {
  ...
  Future<void> fetchDocuments() async {
    try {
      ...
      final sectionKey = "banking"; // Manually set section name for now
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: (String value) async {
                  ...
                  switch (value) {
                    ...
                    case 'Download Image':
                      downloadImage(context,imageUrl, "banking_${index + 1}.jpg");
                      break;
                  }
                },
