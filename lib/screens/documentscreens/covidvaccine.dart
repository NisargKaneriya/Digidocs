...
class Covidvaccine extends StatefulWidget {
  ...
  const Covidvaccine({Key? key, required this.section}) : super(key: key);
...
class _CovidvaccineState extends State<Covidvaccine> {
  ...
  Future<void> fetchDocuments() async {
    try {
      ...
      final sectionKey = "covidvaccine"; // Manually set section name for now
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: (String value) async {
                  ...
                  switch (value) {
                    ...
                    case 'Download Image':
                      downloadImage(context,imageUrl, "covidvaccine_${index + 1}.jpg");
                      break;
                  }
                },
