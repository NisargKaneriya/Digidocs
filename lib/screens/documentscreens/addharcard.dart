...
class Addharcard extends StatefulWidget {
  ...
  const Addharcard({Key? key, required this.section}) : super(key: key);
...
class _AddharcardState extends State<Addharcard> {
  ...
  Future<void> fetchDocuments() async {
    try {
      ...
      final sectionKey = "adharcard"; // Manually set section name for now
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: (String value) async {
                  ...
                  switch (value) {
                    ...
                    case 'Download Image':
                      downloadImage(context,imageUrl, "adharcard_${index + 1}.jpg");
                      break;
                  }
                },
