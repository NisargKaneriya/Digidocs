...
class Otherdocs extends StatefulWidget {
  ...
  const Otherdocs({Key? key, required this.section}) : super(key: key);
...
class _OtherdocsState extends State<Otherdocs> {
  ...
  Future<void> fetchDocuments() async {
    try {
      ...
      final sectionKey = "otherdocs"; // Manually set section name for now
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: (String value) async {
                  ...
                  switch (value) {
                    ...
                    case 'Download Image':
                      downloadImage(context,imageUrl, "otherdocs_${index + 1}.jpg");
                      break;
                  }
                },
