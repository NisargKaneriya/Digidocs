...
class Idcard extends StatefulWidget {
  ...
  const Idcard({Key? key, required this.section}) : super(key: key);
...
class _IdcardState extends State<Idcard> {
  ...
  Future<void> fetchDocuments() async {
    try {
      ...
      final sectionKey = "idcard"; // Manually set section name for now
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: (String value) async {
                  ...
                  switch (value) {
                    ...
                    case 'Download Image':
                      downloadImage(context,imageUrl, "idcard_${index + 1}.jpg");
                      break;
                  }
                },
