...
class Sportsandcultural extends StatefulWidget {
  ...
  const Sportsandcultural({Key? key, required this.section}) : super(key: key);
...
class _SportsandculturalState extends State<Sportsandcultural> {
  ...
  Future<void> fetchDocuments() async {
    try {
      ...
      final sectionKey = "sportsandcultural"; // Manually set section name for now
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: (String value) async {
                  ...
                  switch (value) {
                    ...
                    case 'Download Image':
                      downloadImage(context,imageUrl, "sportsandcultural_${index + 1}.jpg");
                      break;
                  }
                },
