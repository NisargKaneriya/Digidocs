...
class Billsandreceipts extends StatefulWidget {
  ...
  const Billsandreceipts({Key? key, required this.section}) : super(key: key);
...
class _BillsandreceiptsState extends State<Billsandreceipts> {
  ...
  Future<void> fetchDocuments() async {
    try {
      ...
      final sectionKey = "billsandreceipts"; // Manually set section name for now
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: (String value) async {
                  ...
                  switch (value) {
                    ...
                    case 'Download Image':
                      downloadImage(context,imageUrl, "billsandreceipts_${index + 1}.jpg");
                      break;
                  }
                },
