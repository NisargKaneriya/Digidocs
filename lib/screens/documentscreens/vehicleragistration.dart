...
class Vehicleragistration extends StatefulWidget {
  ...
  const Vehicleragistration({Key? key, required this.section}) : super(key: key);
...
class _VehicleragistrationState extends State<Vehicleragistration> {
  ...
  Future<void> fetchDocuments() async {
    try {
      ...
      final sectionKey = "vehicleragistration"; // Manually set section name for now
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: (String value) async {
                  ...
                  switch (value) {
                    ...
                    case 'Download Image':
                      downloadImage(context,imageUrl, "vehicleragistration_${index + 1}.jpg");
                      break;
                  }
                },
