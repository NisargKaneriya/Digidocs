...
class Passport extends StatefulWidget {
  ...
  const Passport({Key? key, required this.section}) : super(key: key);
...
class _PassportState extends State<Passport> {
  ...
  Future<void> fetchDocuments() async {
    try {
      ...
      final sectionKey = "passport"; // Manually set section name for now
              ...
              trailing: PopupMenuButton<String>(
                ...
                onSelected: (String value) async {
                  ...
                  switch (value) {
                    ...
                    case 'Download Image':
                      downloadImage(context,imageUrl, "passport_${index + 1}.jpg");
                      break;
                  }
                },
